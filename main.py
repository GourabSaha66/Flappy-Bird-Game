...
def welcomeScreen():
    ...
    while True:
        for event in pygame.event.get():
            #if user click the cross button, close the game
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Gourab')
    ...
    while True:
        welcomeScreen() #Shows welcome screen to the user untill we press a button
